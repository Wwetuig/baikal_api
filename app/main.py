...
app.include_router(satellete_data_files.satellite_data_firstSD_router,
                   prefix="/api/v1/files/satellite_data", tags=["Satellite data (Landsat)"])
app.include_router(satellete_data_files.satellite_data_secondSD_router,
                   prefix="/api/v1/files/satellite_data", tags=["Satellite data (Monthly Avg)"])
app.include_router(satellete_data_files.satellite_data_thirdSD_router,
                   prefix="/api/v1/files/satellite_data", tags=["Satellite data (Monthly Avg Many Years)"])
app.include_router(satellete_data_files.satellite_data_router,
