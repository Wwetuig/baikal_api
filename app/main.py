...
try:
    ee.Initialize(project='baikal-gee') #!!УКАЗЫВАЙТЕ СВОЙ ПРОЕКТ GEE
...
app = FastAPI(swagger_ui_init_oauth={
    ...
    "appName": "API Login",
    "requestBodyFormat": "json"  # Форсируем JSON
    },
        swagger_ui_parameters={
        "displayOAuth2": False,  # Скрывает кнопку Authorize
        "oauth2RedirectUrl": None,  # Отключает OAuth2 редирект
    }
)
